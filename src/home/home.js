  ...
  const careerList = [
    {
      ...
      subtitle: "개인 프로젝트",
      date: "22.02 ~ 22.12",
      comment: "대학교를 다니며 만든 공부 정리 사이트. 해시태그를 사용하여 렌더링하며 github.io 전용 블로그로 만들었다.",
    ...
    },
    {
      ...
      subtitle: "개인 프로젝트",
      date: "21.02 ~ 21.02",
      comment: "모바일 터치형 Open RPG, 낚시 수집 사냥 꾸미기 등 여러 콘텐츠가 존재함. 최종목표는 P2P 등으로 멀티구현하는 것이다.",
    ...
    },
    {
      ...
      subtitle: "개인프로젝트",
      date: "23.01 ~ 23.06",
      comment: "나중에 게임개발 끝나면, 사람들이 게임을 쉽게 찾을 수 있도록 열어둘 게임 공식 사이트. 처음에는 대학교 리눅스 수업 때 버츄얼박스로 호스팅하여 쓰던 웹이다.",
